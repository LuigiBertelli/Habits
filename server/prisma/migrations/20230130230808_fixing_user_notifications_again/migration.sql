...
INSERT INTO "new_users_notification" ("auth", "endpoint", "expiration_date", "id", "p256dh", "user_id") SELECT "auth", "endpoint", "expiration_date", "id", "p256dh", "user_id" FROM "users_notification";

  ...
  return (
    <div className="w-full max-w-xl mx-auto flex items-center justify-between">
        ...
        <Dialog.Root> 
          <Dialog.Trigger 
            type="button"
            className="flex gap-3 items-center border border-violet-500 font-semibold rounded-lg px-6 py-4 hover:border-violet-300 transition-colors focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background">
